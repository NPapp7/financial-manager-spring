...
create table if not exists expenses (id number auto_increment, product varchar, category varchar, cost number, description varchar, dateOfTransaction varchar, typeOfTransaction varchar);
